...
var mainD = {
    ...
    update: function() {
	if(this.bool == 1 && pauseKey.isDown){
		this.bool = 0;
	}
	if(this.input.up.isDown && this.bool == 0){
	...
	if(this.input.down.isDown && this.bool == 0){
...
this.bool = 1;		
	...
	if(this.input.right.isDown && this.bool == 0){
		game.state.start('bmain');
		
	}
	if(this.input.left.isDown && this.bool == 0){
