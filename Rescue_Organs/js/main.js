window.onload = function() {
    ...
    function create() {
		...
		loseText = game.add.text(game.world.centerX-50, game.world.centerY, 'The Evil Doctor Vargas', {font:'32px Arial', fill: '#000000'});
		loseText.visible = false;
		loseText2 = game.add.text(game.world.centerX-100, game.world.centerY+50, 'Got Away With Your Organs!', {font:'32px Arial', fill: '#000000'});
